...
const resourcePersons = [
  ...
  { name: 'Prof. Biman Jyoti Medhi', inst: 'Gauhati University', imageUrl: 'https://i1.rgstatic.net/ii/profile.image/733312645595136-1551846767490_Q128/Biman-Medhi.jpg', profileUrl: 'https://www.researchgate.net/profile/Biman-Medhi' },
  ...
  { name: 'Dr. Upakul Mahanta', inst: 'Bhattadev University', imageUrl: 'UM.png', profileUrl: 'https://bhattadevuniversity.ac.in/docs/profiles/BU_Phy_Upakul_Mahanta_CV.pdf' },
];
  ...
  <div class="backdrop-blur bg-white/80 border-b border-neutral-200">
    <div class="mx-auto max-w-6xl px-4 py-2">
      ...
      <div class="flex items-center gap-3">
        ...
        <!-- Title -->
<span
  class="text-sm font-bold tracking-wide uppercase text-rose-700
         leading-none block"
>
          A&A Workshop
        </span>
